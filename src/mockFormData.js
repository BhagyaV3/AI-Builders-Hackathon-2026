export const mockQuestions = [
  {
    ...
    sourceExcerpt: "Applicant name is required.",
    type: "text",
  ...
  },
  {
    ...
    sourceExcerpt: "Contact details are needed to follow up on the application.",
    type: "tel",
  ...
  },
  {
    ...
    sourceExcerpt: "The form varies depending on the document type.",
    type: "select",
