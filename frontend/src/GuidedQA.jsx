...
export default function GuidedQA({
  ...
  return (
    <div className="card floating-card">
      ...
      {/* Grounded Source Citation (Issue 6) */}
      {currentQ.citation && currentQ.citation.quote && (
        <div
          style={{
            margin: "0.75rem 0",
        ...
        >
          <span style={{ fontWeight: "bold", color: "#4f46e5" }}>📌 Document Source Excerpt: </span>
          <em>"{currentQ.citation.quote}"</em>
        </div>
      )}
